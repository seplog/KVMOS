...
PKG_DEPENDS_TARGET="toolchain libcap kmod util-linux libidn2"
...
post_makeinstall_target() {
  ...
  ln -sf libsystemd.so.0.26.0 $INSTALL/usr/lib/libsystemd.so.0
  ln -sf libsystemd.so.0.26.0 $SYSROOT_PREFIX/usr/lib/libsystemd.so.0
}
