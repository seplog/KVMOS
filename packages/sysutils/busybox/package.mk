...
PKG_DEPENDS_TARGET="toolchain busybox:host hdparm dosfstools e2fsprogs zip unzip pciutils usbutils parted procps-ng bash gptfdisk libtirpc"
...
post_install() {
  ...
  add_user root "$ROOT_PWD" 0 0 "Root User" "/storage" "/bin/bash"
  add_group root 0
  add_group users 100
